...
export const ComentariosEvento = (props) => {
  ...
  const comentariosConFavoritos = (comentarios) => {
    ...
    return comentarios.map((comentario) => {
      const autorEsFavorito =
        favoritos.find(
          (favorito) =>
            comentario.usuario_id.id === favorito.usuario_favorito.id
        ) !== undefined;
  ...
  const notificarEliminacionComentario = (comentarioId) => {
    setComentarios(
      comentarios.filter((comentario) => comentarioId !== comentario.id)
    );
  };
  ...
  return (
    <>
      <div className="container">
        ...
        {sortedComentarios(comentariosConFavoritos(comentarios)).map(
          (comentario, index) => {
            return (
              <div key={index}>
                <Comentario
                  ...
                  notificarEliminacionComentario={
                    notificarEliminacionComentario
                  }
